...
class Game:
    ...
    def new(self):
        ...
        # Tanks        
        t1 = Tank(self, "MK1", team=1, input_file="player1.py", color=BLUE, pos=[200, 300], gun_damage=10)
        t2 = Tank(self, "MK2", team=2, input_file="player1.py", color=RED, pos=[400, 100])
        ...
        self.walls.append(Wall(self, [310, 400], [10, 150], BLACK, name="Wall3"))
